    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 4:
          ...
          if (res.data.status === 'Success') {
            (0, _alerts.showAlert)('success', "".concat(type.toUpperCase(), " Updated Successfully!\uD83D\uDE00")); // showAlert('success', `${type} updated successfully!😀`);
          }
...
function () {
  ...
  _regeneratorRuntime().mark(function _callee(tourId) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          stripe = Stripe('pk_test_51PBLffFUSeUK2VeVwICyikLg9OmdWl0lBO7EyVWmk7HOcAUmnpNnt1b2HqNa2ERvvYBU9xstjvsOB7GjfyB6ZHkd00TI84ouNP');
          _context.prev = 1;
          _context.next = 4;
...
//Dom Elements
var leaflet = document.querySelector('#map');
...
if (userDataForm) {
  userDataForm.addEventListener('submit', function (e) {
    e.preventDefault(); //- Creating a multipart form data to send images and other data to the server to be updated

    var form = new FormData();
    form.append('name', document.querySelector('#name').value);
    form.append('email', document.querySelector('#email').value);
    form.append('photo', document.querySelector('#photo').files[0]);
    (0, _updateSettings.updateSettings)(form, 'data'); //Dom Values in case of no photo updated
    ...
    _regeneratorRuntime().mark(function _callee(e) {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            e.preventDefault();
            document.querySelector('.btn--save-password').textContent = 'Updating...'; //Dom Values
